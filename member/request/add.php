...
<div class="container py-2 py-md-5 mt-1 mt-md-4" style="max-width: 720px; min-height: 70vh;">
    <h4 class="text-secondary mb-2 mb-md-4">Tambah Data Anggota</h4>
    ...
    <form action="../request/create.php" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" required name="nama" class="form-control" id="exampleInputId1">
        </div>
        <div class="mb-3">
            <label for="exampleInputId1" class="form-label">Jenis Kelamin</label>
            <select class="form-select" required name="jk" aria-label="Default select example">
        ...
        <div class="mb-3">
            ...
            <input type="file" name="foto" required class="form-control" id="exampleInputId1">
        </div>
